            ...
            <ul class="nav navbar-nav pull-left hidden-md-down">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle nav-link" data-toggle="dropdown" href="#" role="button"
                        ...
                        <img src="<?php echo e(asset('adminassets/img/avatars/6.jpg')); ?>" class="img-avatar"
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <form id="logout-form" action="<?php echo e(route('logout')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <button class="dropdown-item" type=submit>__('words.Logout')</button>
                        </form>
...
</html><?php /**PATH C:\xampp\htdocs\blog\resources\views/dashboard/layouts/navbar.blade.php ENDPATH**/ ?>